...
import { useTylerStore } from "@/stores/tyler";
...
const events = useTylerStore();
const start = moment("15.03.2025", "DD.MM.YYYY").startOf("day");
...
const scores = computed(() => {
  const r = events.accounts.reduce(
    (s, a) => {
      ...
      s.goal =
        _isEmpty(s.goal) && h.players[0].currentMmr >= endMMR
          ? { ...h.players[0], match: h.match }
          : {};
...
const isActive = computed(() => {
  return scores.value.highest.currentMmr >= endMMR;
});
</script>
...
<template>
  <main style="height: 100vh; overflow-y: auto">
    ...
    <v-progress-linear indeterminate v-if="events.loaded < 1" />
    <v-container fluid style="opacity: 0.9" v-if="events.loaded >= 1">
      <v-row>
        <v-col cols="12">
          <v-sheet class="pa-5" elevation="5">
            <v-row>
              <v-col cols="12">
                <v-row class="text-md-h4 text-h5">
                  <v-col cols="12" md="6" class="text-center">
                    <span class="text-gold"
                      >Tyler1's Road To {{ endMMR }} MMR</span
                    >
                  </v-col>
                  <v-col cols="12" md="6" class="text-center">
                    <v-progress-circular
                    ...
                    <v-row class="text-center">
                      <v-col cols="12">
                        <section>
                          ...
                          <span
                            ...
                            style="vertical-align: middle">
                            Games played since OnlyFangs Invitational ended
                      ...
                      <v-col cols="12" md="6">
                        <div class="text-subtitle-2">
                          Before OnlyFangs Invitational
                        </div>
                        <ResultChart percentage :result="events.games.before" />
                      </v-col>
                      <v-col cols="12" md="6">
                        <div class="text-subtitle-2">
                          After OnlyFangs Invitational
                        </div>
                            ...
                            <v-col cols="12">
                              ...
                              <v-sheet
                                ...
                                <section class="mt-1">
                                  ...
                                  <strong>{{
                                    numberOfGames(
                                      endMMR - prediction.current,
                                      prediction.gain,
                                    )
                                  }}</strong>
                                  <span
                                    v-if="prediction.total || prediction.saul">
                                    games, to reach {{ endMMR }} MMR.
                                  </span>
                                  <span v-else>
                                    games on this account, to reach
                                    {{ endMMR }} MMR.
                                  </span>
                                </section>
              ...
              <v-col cols="12" class="text-center">
                ...
                <span
                  :style="{
                    ...
                    bottom: '54px',
                    left: `${
                      ((scores.highest.currentMmr - startMMR) /
                        (endMMR - startMMR)) *
                      100
                    }%`,
                  }">
                ...
                <span
                  :style="{
                    ...
                    width: '0px',
                    bottom: '84px',
                    left: `${((scores.lowest.currentMmr - startMMR) / (endMMR - startMMR)) * 100}%`,
                  }">
                  <span
                    v-if="scores.lowest.currentMmr > startMMR"
                    class="text-caption font-weight-bold text-no-wrap"
                    style="
                      font-size: 0.65rem !important;
                      color: grey;
            ...
            <v-row>
              <v-col
                ...
                <Bar
                    ...
                    datasets: [
                      {
                        ...
                        borderColor: 'green',
                        data: events.data[account].season[Race.Orc].matches
                  ...
                  :options="options" />
                <span class="unbanned">TOURNAMENT ENDED</span>
              </v-col>
            </v-row>
